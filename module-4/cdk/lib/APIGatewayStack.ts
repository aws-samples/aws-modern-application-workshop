...
interface APIGatewaySchemaStackProps extends cdk.StackProps {
  EcsStack: EcsStack;
}
export class APIGatewaySchemaStack extends cdk.Stack {

  constructor(scope: cdk.App, id: string, props: APIGatewaySchemaStackProps) {
    super(scope, id);
